...
public class NewModelHorse extends ModelBase
{
    ...
    {
        NewEntityHorse NewEntityHorse = (NewEntityHorse)p_78088_1_;
        int i = NewEntityHorse.getHorseType();
        float f6 = NewEntityHorse.getGrassEatingAmount(0.0F);
        boolean flag = NewEntityHorse.isAdultHorse();
        boolean flag1 = flag && NewEntityHorse.isHorseSaddled();
        boolean flag2 = flag && NewEntityHorse.isChested();
        boolean flag3 = i == 1 || i == 2;
        float f7 = NewEntityHorse.getHorseSize();
        boolean flag4 = NewEntityHorse.riddenByEntity != null;
    ...
    public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        NewEntityHorse NewEntityHorse = (NewEntityHorse)p_78086_1_;
        float f8 = NewEntityHorse.getGrassEatingAmount(p_78086_4_);
        float f9 = NewEntityHorse.getRearingAmount(p_78086_4_);
        float f10 = 1.0F - f9;
        float f11 = NewEntityHorse.func_110201_q(p_78086_4_);
        boolean flag = NewEntityHorse.field_110278_bp != 0;
        boolean flag1 = NewEntityHorse.isHorseSaddled();
        boolean flag2 = NewEntityHorse.riddenByEntity != null;
